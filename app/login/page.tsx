        ...
        >
          ...
          <div className="text-center mb-8 relative z-10">
            ...
            <p className="mt-3 text-sm text-stone-500 font-medium tracking-wide">
              Đăng nhập bằng Google để truy cập gia phả.
            </p>
            {isDemo && (
              <motion.div
          ...
          <div className="relative z-10">
            <button
              ...
              disabled={loading}
              className="group relative w-full flex justify-center items-center gap-3 py-4 px-4 text-[15px] font-bold rounded-xl text-stone-900 bg-white hover:bg-stone-50 border border-stone-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-stone-900 disabled:opacity-70 disabled:cursor-wait transition-all duration-300 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)] hover:shadow-md hover:-translate-y-0.5"
            >
              {loading ? (
                <span className="flex items-center gap-2.5">
                  <svg
                    className="animate-spin -ml-1 h-4 w-4 text-stone-900"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                    <circle
